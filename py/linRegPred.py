...
def getNumSplits(
        ...
        cvSize: int = 0,
        unknownSize: int = 0,
        wfs: Optional[List[str]] = None, ) -> int:
    if wfs is None:
...
def showResults(
    ...
    if not cvSummary:
        ...
        grouped.sort(
                key=lambda
                    x: float(x[math.floor(len(g) / 2)][3])
    ...
    models: List[Tuple[str, Any, Union[None, Dict[str, Any]], str, Union[None, Dict[str, Any]]]] = [
        ...
        (
            ...
            neural_network.MLPRegressor(max_iter=maxiterPos, ),
            {
                ...
                "tol"               : ScistatsNormBetween(0, 1e-2, clip=True, cond=lambda
                    x: x >= 1e-5),
                "warm_start"        : [True, False],
