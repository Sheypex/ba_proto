...
class MethylRecpRecipe(WfChefWorkflowRecipe):
    """A MethylRecp workflow recipe class for creating synthetic workflow instances.
    ...
    @functools.cache
    def _generate_task_files(self, task):
        return super()._generate_task_files(task)
